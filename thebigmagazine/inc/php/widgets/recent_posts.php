...
class RecentPosts extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 
			'tbm_recent_posts',
			__('TBM Recent Posts', 'thebigmag'),
			array( 'description' => __( 'Display recent posts for TBM theme.', 'thebigmag' ), )
		);
		...
		while ( $query->have_posts() ) {
			...
			if( $flag == false ) {
				...
				<div class="row featured">
					<?php TBM_Print::post_thumbnail('medium'); ?>
			...
			// Show the content ?>
			<div class='row'>
				<div class="col-lg-4 thumbnail"><?php TBM_Print::post_thumbnail('small'); ?></div>
				<div class="col-lg-8">
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Posts Limit:' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'cat_id' ); ?>"><?php _e( 'Posts Category:' ); ?></label> 
